...
public class DriveTrain extends Subsystem {
    ...
    private final CANTalon leftDrive = RobotMap.driveTrainLeftDrive;
    private final CANTalon rightDrive = RobotMap.driveTrainRightDrive;
    ...
    {
    	driveMotors.arcadeDrive(j.getY(), j.getZ());
    }
    
    public void ToggleShifters(){
    	if(leftDriveShifter.get() == Value.kReverse)
    	{
